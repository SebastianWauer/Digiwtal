...
<div style="max-width: 800px; margin: 40px auto; padding: 20px;">
    <div style="background: white; padding: 30px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        ...
        <div style="margin-bottom: 30px;">
            <h1 style="margin: 0 0 6px 0; font-size: 28px;">Neuer Kunde</h1>
        ...
        <form method="POST" action="/admin/customers">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 15px;">
                <div>
                    ...
                    <input type="text" name="name"
                           value="<?php echo htmlspecialchars((string)($old['name'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>"
                           required autofocus
                ...
                <div>
                    ...
                    <input type="text" name="domain"
                           value="<?php echo htmlspecialchars((string)($old['domain'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>"
            ...
            <div style="margin-bottom: 15px;">
                ...
                <textarea name="notes" rows="3"
                          ...
                          style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-size: 14px; box-sizing: border-box; resize: vertical;"><?php echo htmlspecialchars((string)($old['notes'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></textarea>
            </div>

            <div style="margin-bottom: 20px;">
                <label style="display: flex; align-items: center; gap: 8px; font-size: 14px; cursor: pointer;">
                    <input type="checkbox" name="is_active"
                           <?php echo (isset($old['isActive']) ? ($old['isActive'] ? 'checked' : '') : 'checked'); ?>>
